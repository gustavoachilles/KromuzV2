    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-black">
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
        ...
        <div
          ...
          className="rounded-2xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-12 text-center cursor-pointer hover:border-teal-400 hover:bg-teal-50/30 dark:hover:bg-teal-950/10 transition"
        >
          ...
          <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden">
            ...
            <div className="px-6 py-4 border-t border-zinc-100 dark:border-zinc-800 flex justify-end gap-3">
              ...
              <button onClick={importar} disabled={importando}
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-teal-500/25 hover:opacity-95 disabled:opacity-50 transition">
        ...
        {/* Sucesso */}
        {resultado && (
          <div className="rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900 px-5 py-6 text-center">
            ...
            <p className="text-sm text-emerald-600 dark:text-emerald-400 mt-1">Os leads foram adicionados com status &quot;Novo&quot;.</p>
            <button onClick={() => router.push("/leads")}
              className="mt-4 px-5 py-2 rounded-lg bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition">
              Ver Leads →
            </button>
          </div>
        )}
