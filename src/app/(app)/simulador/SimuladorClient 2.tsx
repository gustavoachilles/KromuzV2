      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-300 text-sm">Dados extraídos do HISCON</p>
          </div>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div>
            <p className="text-slate-400 text-xs font-medium uppercase tracking-wider mb-1">Idade</p>
            <p className="text-xl font-semibold">{cliente.idade} anos</p>
          </div>
          <div>
            <p className="text-slate-400 text-xs font-medium uppercase tracking-wider mb-1">Espécie</p>
            <p className="text-xl font-semibold">{cliente.especie}</p>
          </div>
          <div>
