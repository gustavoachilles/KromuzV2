...
const AtualizarLeadSchema = z.object({
  ...
  ddb: z.string().nullable().optional(),
  cep: z.string().nullable().optional(),
  logradouro: z.string().nullable().optional(),
  numero: z.string().nullable().optional(),
  complemento: z.string().nullable().optional(),
  bairro: z.string().nullable().optional(),
  bancoCliente: z.string().nullable().optional(),
  agenciaCliente: z.string().nullable().optional(),
  contaCliente: z.string().nullable().optional(),
  tipoContaCliente: z.string().nullable().optional(),
  ...
  try {
    ...
    const leadAtualizado = await prisma.lead.update({
      ...
      data: {
        ...
        renda: body.renda,
        ddb: body.ddb ? new Date(body.ddb) : body.ddb === null ? null : undefined,
        cep: body.cep,
